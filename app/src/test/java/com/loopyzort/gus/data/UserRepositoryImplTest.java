...
public class UserRepositoryImplTest {
    ...
    public void searchUsers_200OkResponse_InvokesCorrectApiCalls() {
        ...
        Assert.assertEquals(USER_LOGIN_LOOPYZORT, users.get(0).getLogin());
        Assert.assertEquals(USER_LOGIN_2_REBECCA, users.get(1).getLogin());
        verify(githubUserRestService).searchGithubUsers(USER_LOGIN_LOOPYZORT);
        verify(githubUserRestService).getUser(USER_LOGIN_LOOPYZORT);
    ...
    public void searchUsers_IOExceptionThenSuccess_SearchUsersRetried() {
        ...
        verify(githubUserRestService, times(2)).searchGithubUsers(USER_LOGIN_LOOPYZORT);
    ...
    public void searchUsers_GetUserIOExceptionThenSuccess_SearchUsersRetried() {
        ...
        verify(githubUserRestService, times(2)).getUser(USER_LOGIN_LOOPYZORT);
        verify(githubUserRestService).getUser(USER_LOGIN_2_REBECCA);
    }
    ...
    public void searchUsers_OtherHttpError_SearchTerminatedWithError() {
        ...
        verify(githubUserRestService, never()).getUser(USER_LOGIN_LOOPYZORT);
